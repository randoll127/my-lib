...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.REQUEST_START = undefined;
	exports.fetch = fetch;
	exports.post = post;
	...
	var REQUEST_START = exports.REQUEST_START = 'REQUEST_START'; //request start
	...
	function fetch(url, callback) {
	    return function (dispatch) {
	        ...
	        return _superagent2.default.get(url).withCredentials().end(function (err, res) {
	            if (!err) {
	...
	function post(url, body, callback, type) {
	    return function (dispatch) {
	        dispatch(requestStart(url));
	        return _superagent2.default.post(url).type(type || 'form').send(body).end(function (err, res) {
	            if (!err) {
	                dispatch(callback(url, res.body));
	            } else {}
	        });
